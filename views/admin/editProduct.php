<div class="center-contenedor-product">
    <div class="contenedor-product">
        ...
        ?>
        <form <?php echo $url?> class="login" method="POST">
            ...
            <p>Precio: <input type="name" required="required" name="precio" value="<?php echo($product->precio); ?>"/></p>
            <p> Foto: <input type="text" required="required" name="foto" value="<?php echo($product->foto); ?>"/> </p>
