<div class="center-contenedor-product">
    <div class="contenedor-product">
        ...
        <form class="login" action="index.php?controller=Admin&action=postEditProduct" method="POST"
            enctype="multipart/form-data">
            <p>ID: <input type="text" readonly name="id" value="<?php echo ($product["id"]); ?>" /></p>
            <p>Nombre: <input type="text" required="required" name="nombre"
                    value="<?php echo ($product["nombre"]); ?>" />
            </p>
            <p>Autor: <input type="text" required="required" name="autor" value="<?php echo ($product["autor"]); ?>" />
            </p>
            <p>Descripción: <input required="required" name="descripcion"
                    value="<?php echo ($product["descripcion"]); ?>"></input></p>
            <p>Precio: <input type="number" step=".01" required="required" name="precio"
            ...
            <p>Stock: <input type="number" step="1" required="required" name="stock"
