...
<section class="tabla">
    <form class="d-flex" action="index.php?controller=Admin&action=postSearchProduct" method="post">
        <div class="b-left">
            ...
            <a class="b_menu" href="index.php?controller=Admin&action=viewTableOrders">Lista de Pedidos</a>
        </div>
    ...
    <table class="content-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a title="Edit" href="index.php?controller=Admin&action=editProduct&id=<?php echo ($v->id); ?>">
